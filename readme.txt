...
B:打开Shiro root源码包：samples/quickstart/src/下的两个配置文件
  log4j.properties,shiro.ini文件到src目录下
  
C:修改shiro.ini
lonestarr = vespa, goodguy, schwartz--->mike = 123, a, b
schwartz = lightsaber:*---------------->a=read:*

D:新建包：com.itany.shiro.helloworld，创建类：FirstShiroTest.java
    ...
    public static void main(String[] args) {
        ...
        if(!currentUser.isAuthenticated()) {
            ...
            //用户被锁定的异常
            	...
            	System.out.println("用户名【"+token.getPrincipal()+"】的账号已被锁定，
            	请联系你的管理员解锁");
            }
             //所有认证时异常的父类
        ...
        // 执行登出
        System.out.println("【"+currentUser.getPrincipal()+"】是否被认证：" + 
...
E:修改log4j.properties
  log4j.logger.org.apache.shiro=trace------>log4j.logger.org.apache.shiro=info
